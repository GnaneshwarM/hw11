...
var SimpleForm = function (_a) {
    ...
    return (React.createElement(Form, __assign({ key: props.version, initialValues: finalInitialValues, onSubmit: submit, mutators: __assign({}, arrayMutators), keepDirtyOnReinitialize: true, subscription: defaultSubscription }, props, { render: function (formProps) { return (React.createElement(SimpleFormView, __assign({ saving: formProps.submitting || saving, translate: translate, setRedirect: setRedirect }, props, formProps))); } })));
};
...
var SimpleFormView = function (_a) {
    ...
    return (React.createElement("form", __assign({ className: classnames('simple-form', className) }, sanitizeRestProps(rest)),
        React.createElement(CardContentInner, { key: version }, Children.map(children, function (input) {
