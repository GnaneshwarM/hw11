...
var SimpleFormIterator = /** @class */ (function (_super) {
    ...
    SimpleFormIterator.prototype.render = function () {
        ...
        return fields ? (react_1.default.createElement("ul", { className: classes.root },
            submitFailed && typeof error !== 'object' && error && (react_1.default.createElement(FormHelperText_1.default, { error: true },
                react_1.default.createElement(ra_core_1.ValidationError, { error: error }))),
            react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: null }, fields.map(function (member, index) { return (react_1.default.createElement(react_transition_group_1.CSSTransition, { key: _this.ids[index], timeout: 500, classNames: "fade" },
