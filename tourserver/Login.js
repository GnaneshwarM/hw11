...
//const users = require('./tourServer/userTours.json');
  ...
  render() {
    ...
    <main className ="main_tour">
      ...
      <form>
        ...
        Email : <input type="text" ref="email" onChange={this.setEmail} placeholder="Enter your email here" /><br/>
        Password: <input type="password" ref="password" onChange={this.setPassword} placeholder="Enter your password here" /><br/>
